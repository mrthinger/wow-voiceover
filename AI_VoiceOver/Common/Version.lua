...
Version.IsLegacyClassic         = Version.IsAnyLegacy and Version.Interface ==     0 or nil
...
Version.IsRetailClassic         = Version.IsAnyRetail and WOW_PROJECT_ID == WOW_PROJECT_CLASSIC or nil
...
function Version:IsLegacyVersionBelow(version)
    return self.IsAnyLegacy and self.Interface < version or nil
end
function Version:IsRetailOrLegacyVersionAbove(version)
